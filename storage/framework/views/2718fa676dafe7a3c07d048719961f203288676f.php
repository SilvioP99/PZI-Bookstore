            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm table-striped table-condensed table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><?php echo e($user->surname); ?></td>
                                <td class="align-middle"><?php echo e($user->email); ?></td>
                                <td>
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                    <a id="editUserBtn" href="<?php echo e(route("users.get", $user->id)); ?>" class="btn btn-sm btn-outline-secondary"><i class="far fa-edit"></i> Uredi</a>
                                    <a href="<?php echo e(route("users.delete", $user->id)); ?>" class="btn btn-sm btn-outline-danger"><i class="far fa-trash-alt"></i> Pobriši</a>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="modal  fade" id="addUsersModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel" aria-hidden="true">
                        <form id="addUsersForm" method="POST" action="<?php echo e(route('users.store')); ?>" >
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" id="name" value="<?php echo e(old('name')); ?>" placeholder="Unesite ime korisnika">
...
unset($__errorArgs, $__bag); ?>" name="surname" id="surname" placeholder="Unesite prezime korisnika">
...
unset($__errorArgs, $__bag); ?>" name="email" id="email" placeholder="Unesite email korisnika">
...
unset($__errorArgs, $__bag); ?>" name="role" id="role" placeholder="Odaberite ulogu">
...
unset($__errorArgs, $__bag); ?>" name="password" id="password" placeholder="Unesite lozinku">
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" id="password_confirmation" placeholder="Ponovite lozinku">
                                    </div>
